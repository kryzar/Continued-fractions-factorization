...
valuation impaire \NTS{on n'a pas expliqué pourquoi on ne regardait que les
valuations impaires}. Dans le but d'augmenter le nombre de paires $(A,Q)$
...
supplémentaire \NTS{réf vers la partie du rapport correspondante ?}. Les
...
\NTS{réf à avant}. Chaque ensemble de paires $(A, Q)$ valide trouvé fournit une
